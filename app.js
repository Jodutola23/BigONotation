...
console.log("1. O(n + 10) -> O(n)");
console.log("2. O(100 * n) -> O(n)");
console.log("3. O(25) -> O(1)");
console.log("4. O(n^2 + n^3) -> O(n^3)");
console.log("5. O(n + n + n + n) -> O(n)");
console.log("6. O(1000 * log(n) + n) -> O(n)");
console.log("7. O(1000 * n * log(n) + n) -> O(n log n)");
console.log("8. O(2^n + n^2) -> O(2^n)");
console.log("9. O(5 + 3 + 1) -> O(1)");
console.log("10. O(n + n^(1/2) + n^2 + n * log(n)^10) -> O(n^2))");
...
function logUpTo(n) {
  ...
  //Time Complexity: O(n): includes is on a fixed length string
  // the max number of keys is 10
